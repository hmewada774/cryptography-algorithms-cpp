...
// CFB Encryption
string cfbEncrypt(string plaintext, int iv, int k1, int k2, int k3, int k4)
{
    string ciphertext = "";
    int feedback = iv;
...
// CFB Decryption
string cfbDecrypt(string ciphertext, int iv, int k1, int k2, int k3, int k4)
{
    string plaintext = "";
    int feedback = iv;
...
int main()
{
    ...
    // Encryption
    string encrypted = cfbEncrypt(text, iv, k1, k2, k3, k4);
    ...
    // Decryption
    string decrypted = cfbDecrypt(encrypted, iv, k1, k2, k3, k4);
